...
public class PayByUSSD extends TestBase {
    @Test
    public void Pay_USSD() throws IOException, InterruptedException {
        test = extent.createTest("Pay USSD");
