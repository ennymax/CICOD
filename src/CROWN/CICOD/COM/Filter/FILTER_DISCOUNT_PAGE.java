...
public class FILTER_DISCOUNT_PAGE extends TestBase {
    ...
    public void FILTER_DISCOUNT_PAGE() throws IOException, InterruptedException, AWTException {
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertRegionagegePresent_XPATH", "Regpassmsg_TEXT", "RegFailmsg_TEXT", 15);
        assertion.DoAssertXpathAbsentWhenReady("Assertabs_XPATH", "Regpassmsg_TEXT", "RegFailmsg_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertRegionagegePresent_XPATH", "percpassmsg_TEXT", "percFailmsg_TEXT", 15);
        assertion.DoAssertXpathAbsentWhenReady("Assertabs_XPATH", "percpassmsg_TEXT", "percFailmsg_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertRegionagegePresent_XPATH", "Disppassmsg_TEXT", "DispFailmsg_TEXT", 15);
        assertion.DoAssertXpathAbsentWhenReady("Assertabs_XPATH", "Disppassmsg_TEXT", "DispFailmsg_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("Activests_XPATH", "fstapassmsg_TEXT", "fstaFailmsg_TEXT", 5);
        ...
        assertion.DoAssertXpathAbsentWhenReady("AssertRegionagegePresent_XPATH", "fstapassmsg1_TEXT", "fstaFailmsg1_TEXT", 5);
        assertion.DoAssertXpathAbsentWhenReady("Assertabs_XPATH", "fstapassmsg1_TEXT", "fstaFailmsg1_TEXT", 1);
        utility.DoSelectValuesByIndex("FStatus_XPATH","vv_TEXT",0,6);

        //Created By
        utility.DoSendKeysWhenReadyEnter("DCreatedby_XPATH", "DCreatedby_TEXT", "DCreatedby_TEXT", 4);
        assertion.DoAssertXpathPresentWhenReady("AssertRegionagegePresent_XPATH", "Dcreatedbypassmsg_TEXT", "DcreatedbyFailmsg_TEXT", 5);
        assertion.DoAssertXpathAbsentWhenReady("Assertabs_XPATH", "Dcreatedbypassmsg_TEXT", "DcreatedbyFailmsg_TEXT", 5);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertRegionagegePresent_XPATH", "Fcreateddatepassmsg_TEXT", "FcreateddateFailmsg_TEXT", 5);
