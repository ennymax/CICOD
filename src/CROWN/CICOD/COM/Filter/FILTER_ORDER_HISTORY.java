...
import CROWN.utility.ActionsClass;
...
public class FILTER_ORDER_HISTORY extends TestBase {
    ...
    public void FILTER_ORDER_HISTORY() throws IOException, InterruptedException, AWTException {
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpass_TEXT", "FilterOfail_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpassID_TEXT", "FilterOfailID_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpassAmt_TEXT", "FilterOfailAmt_TEXT", 15);
        actionsClass.DoClearActionclassWhenReady("fna_XPATH", 40);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpassAcctbal_TEXT", "FilterOfailAcctbal_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpassCreditlimi_TEXT", "FilterOfailCreditLimi_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpassCrNote_TEXT", "FilterOfailCrenote_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("t1ASS_XPATH", "FilterOpasst1_TEXT", "FilterOfailt1_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FiltChnel_XPATH", "t2_TEXT", "t2_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("AssertDstOrde_XPATH", "FilterOpasst2_TEXT", "FilterOfailt2_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FiltChnel_XPATH", "t3_TEXT", "t3_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("t3Asser_XPATH", "FilterOpasst3_TEXT", "FilterOfailt3_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FiltChnel_XPATH", "t4_TEXT", "t4_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("t4Assert_XPATH", "FilterOpasst4_TEXT", "FilterOfailt4_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertInvoiceFilt_XPATH", "FilterOpassinvo_TEXT", "FilterOfailinvo_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("Assertmode1_XPATH", "FilterOpassinvomide_TEXT", "FilterOfailinvomod_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode2_TEXT", "mode2_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("AssertMode2_XPATH", "FilterOpassinvomide2_TEXT", "FilterOfailinvomod2_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode3_TEXT", "mode3_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertmod3_XPATH", "FilterOpassinvomide3_TEXT", "FilterOfailinvomod3_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode4_TEXT", "mode4_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("AssertMode4_XPATH", "FilterOpassinvomide4_TEXT", "FilterOfailinvomod4_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode5_TEXT", "mode5_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("AssertMode5_XPATH", "FilterOpassinvomide5_TEXT", "FilterOfailinvomod5_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode6_TEXT", "mode6_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertmode6_XPATH", "FilterOpassinvomide6_TEXT", "FilterOfailinvomod6_TEXT", 15);

        utility.DoSelectValuesByVisibleText("PaymentMode_XPATH", "mode7_TEXT", "mode7_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertmode7_XPATH", "FilterOpassinvomide7_TEXT", "FilterOfailinvomod7_TEXT", 15);
        ...
        assertion.DoAssertXpathPresentWhenReady("AssertOrder1_XPATH", "FilterOpassiDeli1_TEXT", "FilterOfailiDel1_TEXT", 15);

        utility.DoSelectValuesByVisibleText("OrderHDeli_XPATH", "Order2_TEXT", "Order2_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertmod2_XPATH", "FilterOpassiDeli2_TEXT", "FilterOfailiDel2_TEXT", 15);

        utility.DoSelectValuesByVisibleText("OrderHDeli_XPATH", "Order3_TEXT", "Order3_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertmode3_XPATH", "FilterOpassiDeli3_TEXT", "FilterOfailiDel3_TEXT", 15);
       ...
       */
        ...
        assertion.DoAssertXpathPresentWhenReady("Asserending_XPATH", "FilterOpasOSTA1_TEXT", "FilterOfaiOsat1_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FilterByOrderStatus_XPATH", "OStatus2_TEXT", "OStatus2_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Asserending_XPATH", "FilterOpasOSTA2_TEXT", "FilterOfaiOsat2_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FilterByOrderStatus_XPATH", "OStatus3_TEXT", "OStatus3_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("AssertExpired_XPATH", "FilterOpasOSTA3_TEXT", "FilterOfaiOsat3_TEXT", 15);

        utility.DoSelectValuesByVisibleText("FilterByOrderStatus_XPATH", "OStatus4_TEXT", "OStatus4_TEXT", 30);
        assertion.DoAssertXpathPresentWhenReady("Assertcancelled_XPATH", "FilterOpasOSTA4_TEXT", "FilterOfaiOsat4_TEXT", 15);
