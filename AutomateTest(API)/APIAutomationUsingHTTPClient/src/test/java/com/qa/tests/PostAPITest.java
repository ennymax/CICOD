...
import main.java.com.qa.data.Users;
...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		//object to json file:
		mapper.writeValue(new File(System.getProperty("user.dir")+"/AutomateTest(API)/APIAutomationUsingHTTPClient/src/main/java/com/qa/data/users.json"), users);
