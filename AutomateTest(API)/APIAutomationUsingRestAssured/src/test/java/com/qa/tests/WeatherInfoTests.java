...
import main.java.com.qa.util.TestBase;
...
public class WeatherInfoTests extends TestBase {
	...
	public Object[][] getData(){
		Object testData[][] = TestUtilRestassured.getDataFromSheet(TestUtilRestassured.WeatherSheetName);
		return testData;
	}
	...
	public void getWeatherDetailsWithCorrectCityNameTest(String city,	String HTTPMethod, String humidity, String temperature,	
		...
		Assert.assertEquals(statusCode, TestUtilRestassured.RESPONSE_CODE_200);
