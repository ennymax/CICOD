...
public class TestUtilRestassured {
	...
	public static String TESTDATA_SHEET_PATH = System.getProperty("user.dir") + "/AutomateTest(API)/APIAutomationUsingRestAssured/src/main/java/com/qa/testdata/APITestData.xlsx";
